...
# use random stream orders to have more than 40 distinct orders
tpch_stream_orders = [random.sample(queries, k=len(queries)) for _ in range(256)]


# tpch stream orders as defined by the spec
# tpch_stream_orders = [
